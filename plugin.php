...
final class Plugin {
	...
	public function enqueue_admin_scripts( $hook_suffix ) {
		...
		$script_config = array(
			...
			'isPro'     => spin_wheel_is_pro_activated() ? true : false,
		);
	...
	public function enqueue_app_scripts() {
		...
		if ( isset( $wheel_data['wheelStyles']['othersData']['confettiEffects'] ) ) {
			wp_register_script( 'tsparticles-confetti', SPIN_WHEEL_URL . 'assets/vendor/js/tsparticles.confetti.bundle.min.js', array(), '3.0.3', array( 'in_footer' => true, 'strategy' => 'defer' ) );
