...
class Wheel {
	...
	public static function get_coupon( $reveal = false, $coupon_id = false ) {
		...
		$coupons = $coupons_settings['coupons'] ?? array(
			[ 'label' => '50% OFF', 'value' => 'SW50OFF', 'win' => true, 'probability' => 1 ],
			[ 'label' => '$10 OFF', 'value' => 'SW10%OFF', 'win' => true, 'probability' => 1 ],
			[ 'label' => '80% OFF', 'value' => 'SW80%OFF', 'win' => true, 'probability' => 1 ],
			[ 'label' => 'Flow Mini', 'value' => 'SWFLOWMINI', 'win' => true, 'probability' => 1 ],
			[ 'label' => 'Free Shipping', 'value' => 'SWFREESHIPP', 'win' => true, 'probability' => 1 ],
			[ 'label' => '$20 OFF', 'value' => 'SW$20OFF', 'win' => true, 'probability' => 1 ],
			[ 'label' => '10% OFF', 'value' => 'SW10%OFF', 'win' => true, 'probability' => 1 ],
			[ 'label' => '$25 OFF', 'value' => 'SW$25OFF', 'win' => true, 'probability' => 1 ],
			[ 'label' => '30% OFF', 'value' => 'SW30%OFF', 'win' => true, 'probability' => 1 ],
			[ 'label' => '$5 OFF', 'value' => 'SW$5OFF', 'win' => true, 'probability' => 1 ],
		);
	...
	public static function wheel_styles() {
		...
		if ( $settings ) {
			...
			$styles['othersData'] = $settings['othersData'] ?? false;
		}
